        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.sectionRow}>
              <Text style={styles.sectionText}>Date Posted</Text>
            ...
            <TouchableOpacity style={styles.sectionRow}>
              <Text style={styles.sectionText}>Job Type</Text>
              <Ionicons name="chevron-forward" size={18} color="#555" />
            </TouchableOpacity>

            <TouchableOpacity style={styles.sectionRow}>
              <Text style={styles.sectionText}>Job Mode</Text>
              <Ionicons name="chevron-forward" size={18} color="#555" />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  dropdownLabel: { fontSize: 14, color: '#6B7280' },
  ...
  sectionText: { fontSize: 17, color: '#152139' },
  button: {

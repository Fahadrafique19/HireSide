    ...
    >
      <View style={styles.header}>
        ...
        >
          ...
          <Text style={styles.headerTitles}> 3/4</Text>
        </View>
        ...
        <View style={styles.progressContainer}>
          ...
          <View style={[styles.progressStep, { backgroundColor: '#0C64AE' }]} />
          <View style={[styles.progressStep, { backgroundColor: '#0C64AE' }]} />
          <View style={[styles.progressStep, { backgroundColor: '#E3E8F1' }]} />
        </View>
      </View>
      ...
      <View style={styles.form}>
        ...
        <Text style={styles.question}>
          Have you conducted user research as part of your previous UX design
          projects?
        </Text>
        <View style={styles.radioGroup}>
          <TouchableOpacity
          ...
          >
            <View
              style={[
                styles.radioCircle,
                research === true && styles.radioSelected,
              ]}
            />
            <Text style={styles.radioLabel}>Yes</Text>
          </TouchableOpacity>
          ...
          >
            <View
              style={[
                styles.radioCircle,
                research === false && styles.radioSelected,
              ]}
            />
            <Text style={styles.radioLabel}>No</Text>
          </TouchableOpacity>
        ...
        <Text style={styles.question}>
          How many years of work experience do you have in User Experience
          Field?
        </Text>
        <TextInput
          style={styles.input}
        ...
        <Text style={styles.question}>
          Which analytics tools have you used to gather insights about user
          behavior?
        </Text>
        <TextInput
          style={styles.input}
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ApplyStep4Screen')}
        >
